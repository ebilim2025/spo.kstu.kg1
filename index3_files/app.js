...
(function () {
	...
	function initModeSetting() {
		...
		if (lightDarkBtn && lightDarkBtn.length) {
			lightDarkBtn[0].addEventListener("click", function () {
				var currentTheme = html.getAttribute("data-bs-theme");
				if (currentTheme === "dark") {
					setLayoutMode("data-bs-theme", "light", "layout-mode-light", html);
					localStorage.setItem("theme", "light"); // Save the light mode in localStorage
				} else {
					setLayoutMode("data-bs-theme", "dark", "layout-mode-dark", html);
					localStorage.setItem("theme", "dark"); // Save the dark mode in localStorage
				}
